...
#line 244 "src/Python/SIP/goldencheetah.sip"
#include "Bindings.h"
#line 12 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"

#line 28 "src/Python/SIP/goldencheetah.sip"
#include <qstring.h>
#line 16 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
#line 306 "src/Python/SIP/goldencheetah.sip"
        if (sipCpp->readOnly) {
...
#line 41 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_PythonXDataSeries, sipName_append, SIP_NULLPTR);
...
#line 317 "src/Python/SIP/goldencheetah.sip"
        if (sipCpp->readOnly) {
            PyErr_SetString(PyExc_AttributeError, "Object is read-only");
            sipError = sipErrorFail;
        } else {
...
#line 84 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_PythonXDataSeries, sipName_remove, SIP_NULLPTR);
...
#line 289 "src/Python/SIP/goldencheetah.sip"
        if (sipCpp->readOnly) {
            PyErr_SetString(PyExc_AttributeError, "Object is read-only");
            sipError = sipErrorFail;
        } else {
...
#line 138 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
#line 279 "src/Python/SIP/goldencheetah.sip"
        if (a0 < 0) a0 += sipCpp->count();
        if (a0 >= 0 && a0 < sipCpp->count()) {
...
#line 184 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
#line 275 "src/Python/SIP/goldencheetah.sip"
        sipRes = sipCpp->count();
#line 219 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
#line 271 "src/Python/SIP/goldencheetah.sip"
        sipRes = new QString(sipCpp->name());
#line 244 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
#line 248 "src/Python/SIP/goldencheetah.sip"
    ...
    sipRes = 0;
#line 284 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
...
{
#line 265 "src/Python/SIP/goldencheetah.sip"
    // we do not require any special release function
#line 297 "src/Python/SIP/sipgoldencheetahPythonXDataSeries.cpp"
}
#endif
...
static PyMethodDef methods_PythonXDataSeries[] = {
    {SIP_MLNAME_CAST(sipName_append), meth_PythonXDataSeries_append, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_remove), meth_PythonXDataSeries_remove, METH_VARARGS, SIP_NULLPTR}
};
