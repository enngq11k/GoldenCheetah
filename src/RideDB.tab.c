...
{
       0,    55,    55,    57,    58,    61,    62,    64,    71,    72,
      75,   124,   125,   127,   128,   129,   130,   131,   138,   172,
     173,   173,   174,   183,   193,   205,   206,   207,   208,   209,
     215,   216,   217,   220,   229,   230,   233,   234,   238,   251,
     252,   252,   253,   261,   269,   281,   282,   283,   284,   285,
     290,   291,   291,   292,   297,   298,   304,   305,   305,   306,
     309,   310,   311,   312,   314,   320
};
#endif
...
#line 1264 "RideDB.tab.c"
    break;

  case 10: /* ride: '{' rideelement_list '}'  */
#line 75 "Core/RideDB.y"
                                                                { 
...
#line 1316 "RideDB.tab.c"
    break;

  case 18: /* ride_tuple: string ':' string  */
#line 138 "Core/RideDB.y"
                                                                { 
...
#line 1351 "RideDB.tab.c"
    break;

  case 22: /* metric: metric_key ':' metric_value  */
#line 175 "Core/RideDB.y"
                                                                {
...
#line 1394 "RideDB.tab.c"
    break;

  case 25: /* metric_key: string  */
#line 205 "Core/RideDB.y"
                                                                { jc->key = jc->JsonString; }
#line 1400 "RideDB.tab.c"
    break;

  case 26: /* metric_value: string  */
#line 206 "Core/RideDB.y"
                                                                { jc->value = jc->JsonString; }
#line 1406 "RideDB.tab.c"
    break;

  case 27: /* metric_count: string  */
#line 207 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1412 "RideDB.tab.c"
    break;

  case 28: /* metric_stdmean: string  */
#line 208 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1418 "RideDB.tab.c"
    break;

  case 29: /* metric_stdvariance: string  */
#line 209 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1424 "RideDB.tab.c"
    break;

  case 33: /* interval: '{' intervalelement_list '}'  */
#line 220 "Core/RideDB.y"
                                                                {
...
#line 1437 "RideDB.tab.c"
    break;

  case 38: /* interval_tuple: string ':' string  */
#line 238 "Core/RideDB.y"
                                                                { 
...
#line 1492 "RideDB.tab.c"
    break;

  case 45: /* interval_metric_key: string  */
#line 281 "Core/RideDB.y"
                                                                { jc->key = jc->JsonString; }
#line 1498 "RideDB.tab.c"
    break;

  case 46: /* interval_metric_value: string  */
#line 282 "Core/RideDB.y"
                                                                { jc->value = jc->JsonString; }
#line 1504 "RideDB.tab.c"
    break;

  case 47: /* interval_metric_count: string  */
#line 283 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1510 "RideDB.tab.c"
    break;

  case 48: /* interval_metric_stdmean: string  */
#line 284 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1516 "RideDB.tab.c"
    break;

  case 49: /* interval_metric_stdvariance: string  */
#line 285 "Core/RideDB.y"
                                                                { jc->count = jc->JsonString; }
#line 1522 "RideDB.tab.c"
    break;

  case 53: /* tag: tag_key ':' tag_value  */
#line 293 "Core/RideDB.y"
                                                                {
                                                                    jc->item.metadata().insert(jc->key, jc->value);
                                                                }
#line 1530 "RideDB.tab.c"
    break;

  case 54: /* tag_key: string  */
#line 297 "Core/RideDB.y"
                                                                { jc->key = jc->JsonString; }
#line 1536 "RideDB.tab.c"
    break;

  case 55: /* tag_value: string  */
#line 298 "Core/RideDB.y"
                                                                { jc->value = jc->JsonString; }
#line 1542 "RideDB.tab.c"
    break;

  case 59: /* xdata: xdata_name ':' '[' xdata_values ']'  */
#line 306 "Core/RideDB.y"
                                                                { jc->item.xdata().insert(jc->key,jc->JsonStringList);
                                                                  jc->key = ""; jc->JsonStringList.clear(); }
#line 1549 "RideDB.tab.c"
    break;

  case 60: /* xdata_name: string  */
#line 309 "Core/RideDB.y"
                                                                { jc->key = jc->JsonString; }
#line 1555 "RideDB.tab.c"
    break;

  case 64: /* xdata_value: string  */
#line 314 "Core/RideDB.y"
                                                                { jc->JsonStringList << jc->JsonString; }
#line 1561 "RideDB.tab.c"
    break;

  case 65: /* string: STRING  */
#line 320 "Core/RideDB.y"
                                                             { jc->JsonString = yyvsp[0]; }
#line 1567 "RideDB.tab.c"
    break;


#line 1571 "RideDB.tab.c"
